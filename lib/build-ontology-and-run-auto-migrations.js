...
module.exports = function buildOntologyAndRunAutoMigrations(hook, sails, done) {
  ...
  try {
    ...
    if( _.isEmpty( hook.systemModels ) ) {
      hook.systemModels = _.clone(hook.models)
    }
  ...
  // console.log('example', sails.config.models['contact'])
  // hook.systemModels = _.clone(sails.config.models)
